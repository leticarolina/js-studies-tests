//* -----------------IF /ELSE STATEMENT---------------*//
//sintax if (here goes variable that for reference or js code) {code that will run if true} else { code that will run if false}
...
// } else if (price < 50 && news === 12) {
//   console.log("Thats a good deal");
// } else {
//   console.log("This is expensive");
// } //that's a good deal

//You can only run one condition inside if statement, but that condition can be a complex expression with logical operators (such as &&, ||, etc.).
//Additionally, the if statement can contain multiple statements within its block, enclosed by curly braces {}.
// let a = 5;
// let b = 10;
// if (a > 3 && b == 10) {
//   console.log("Both conditions are true.");
//   console.log("This is another statement within the if block.");
// }
...
//* -----------------TERNARY OPERATOR---------------*//
//more condensed way to create if statement
...
//syntax switch (variable to check) { case CodeForTheCase : codeToRun break }
...
//   case "cat":
//     console.log("Cats are so cute");
//     break; //break after every case so it won't keep running every true case
//   case "dog": //syntax case keyword :  then run statement
//   case "Dog":
//     console.log("Dogs are humans best friend");
//     break;
//   case "horse":
...
//     break;
//   default:
//     /*default keyword is the "else" for if statement*/
...
//example using complex logic for each case, In this scenario, the switch statement checks the value true
// let fruit = "apple";
// let isRed = true;
// let isTasty = false;
// const number = 5;
// switch (true) {
//   case number === 5:
//   case fruit === "apple" && isRed:
//     console.log("It's a red apple.");
//     console.log("number is 5");
//     break;
//   case fruit === "banana" && isTasty:
//     console.log("It's a tasty banana.");
//     break;
...
//   if (start > 4) continue; //this will not run the code that match if statement, will be skipped
//   console.log(start);
// } // 1 2 3
...
//* --------------------------------WHILE LOOP------------------------------*//
//does the same thing as for loop but take only one parameter (the ending point)
//need to declare the starting point as a sepate variable
...
//   callNumber(number + 1); //how to modify our variable
// }
// callNumber(1);
...
// console.log("hi"); //this will run after the whole recursion + return is done
...
//   console.log("bob " + number); /*<- this is BOB in the return statement*/
// }
// printNumber(1);

//* --------------------------------SHORT CIRCUIT EVALUATION------------------------------*//
//short circuit evaluation will skip the rest of the code if the first boolean/code will already return true
//true || or false will always be equal to true, javascript will not evaluate the second boolean bcs the first one already returns true
...
//using and (&&) , javascript will stop at the first false statement and return the last true (opposite as || that stops at the first true statement)
// function printFalse() {
//   console.log("I am false");
//   return false;
// }
...
//when to use &&, this code will short circuit (stop) at the false statement
